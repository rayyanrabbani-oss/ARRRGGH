...
def page_team():
    ...
    team = [
        {"name": "Muhammad Nurul Falah", "photo": placeholder, "role": "Making App"},
        {"name": "Rayyan Hasan Rabbani", "photo": placeholder, "role": "Making App"},
        {"name": "Tobias Dashiel Hapsoro", "photo": placeholder, "role": "Making App"}
    ]
